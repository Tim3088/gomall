...
type CheckoutOrderReq struct {
	...
	CreditCard *payment.CreditCardInfo `protobuf:"bytes,3,opt,name=credit_card,json=creditCard,proto3" json:"credit_card,omitempty"`
}
...
func (x *CheckoutOrderReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *CheckoutOrderReq) GetCreditCard() *payment.CreditCardInfo {
	if x != nil {
		return x.CreditCard
	}
	return nil
...
func (x *CheckoutOrderResp) Reset() {
	*x = CheckoutOrderResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckoutOrderResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckoutOrderResp) ProtoMessage() {}

func (x *CheckoutOrderResp) ProtoReflect() protoreflect.Message {
	mi := &file_checkout_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckoutOrderResp.ProtoReflect.Descriptor instead.
func (*CheckoutOrderResp) Descriptor() ([]byte, []int) {
	return file_checkout_proto_rawDescGZIP(), []int{4}
}

func (x *CheckoutOrderResp) GetTransactionId() string {
	if x != nil {
		return x.TransactionId
	}
	return ""
...
var file_checkout_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x80, 0x01,
	0x0a, 0x10, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	...
	0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74,
	0x5f, 0x63, 0x61, 0x72, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x61,
	...
	0x22, 0x3a, 0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x74,
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x32, 0x9a, 0x01, 0x0a,
	...
	0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x4a, 0x0a,
	0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1a,
	0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f,
	0x75, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x1a, 0x1b, 0x2e, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x6f, 0x75, 0x74, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x24, 0x5a, 0x22, 0x47, 0x6f, 0x2d,
...
var file_checkout_proto_goTypes = []interface{}{
	...
	(*CheckoutOrderReq)(nil),       // 3: checkout.CheckoutOrderReq
	(*CheckoutOrderResp)(nil),      // 4: checkout.CheckoutOrderResp
...
var file_checkout_proto_depIdxs = []int32{
	...
	5, // 2: checkout.CheckoutOrderReq.credit_card:type_name -> payment.CreditCardInfo
	1, // 3: checkout.CheckoutService.Checkout:input_type -> checkout.CheckoutReq
	3, // 4: checkout.CheckoutService.CheckoutOrder:input_type -> checkout.CheckoutOrderReq
	2, // 5: checkout.CheckoutService.Checkout:output_type -> checkout.CheckoutResp
	4, // 6: checkout.CheckoutService.CheckoutOrder:output_type -> checkout.CheckoutOrderResp
...
func file_checkout_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_checkout_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckoutOrderResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type CheckoutService interface {
	...
	CheckoutOrder(ctx context.Context, req *CheckoutOrderReq) (res *CheckoutOrderResp, err error)
}
