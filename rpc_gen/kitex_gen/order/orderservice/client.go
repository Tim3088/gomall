...
func (p *kOrderServiceClient) GetOrderItems(ctx context.Context, Req *order.GetOrderItemsReq, callOptions ...callopt.Option) (r *order.GetOrderItemsResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
